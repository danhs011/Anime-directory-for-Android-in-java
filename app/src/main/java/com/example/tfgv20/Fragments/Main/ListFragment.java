...
public class ListFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        lista = new ArrayList<>();
        recyclerView = vista.findViewById(R.id.RecyclerViewList);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));

        adapter = new MiniaturaAdapter(ListFragment.this.getContext(), lista, resource);
        layoutManager = new GridLayoutManager(ListFragment.this.getContext(), 3);
        ...
        adapter.setOnItemClickListener(new MiniaturaAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                Intent intent = new Intent(ListFragment.this.getContext(), VerEspecificoActicity.class);
